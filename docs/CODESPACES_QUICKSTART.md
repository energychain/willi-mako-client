# 🚀 GitHub Codespaces Quickstart für Willi-Mako Client SDK
...
- [Was ist GitHub Codespaces?](#-was-ist-github-codespaces)
...
**GitHub Codespaces** ist eine Cloud-basierte Entwicklungsumgebung von Microsoft, die direkt im Browser oder in VS Code Desktop läuft. Du benötigst **keine lokale Installation** von Node.js, npm oder anderen Tools – alles ist sofort einsatzbereit!

**Vorteile für Einsteiger:**
- ✅ Keine Installation oder Konfiguration nötig
- ✅ Nahtlose GitHub-Integration (Projekt liegt schon hier!)
- ✅ Funktioniert im Browser ODER in VS Code Desktop
- ✅ Vorinstallierte Dependencies und Tools
- ✅ Sichere, isolierte Umgebung zum Experimentieren
- ✅ **60 Stunden pro Monat kostenlos** (mehr als Gitpod!)
- ✅ Sehr schnelle Start-Zeiten dank Prebuilds
...
**Option A: Via Button (Einfachste Methode)**

Klicke auf den Button oben oder öffne diese URL:
...
1. Gehe zu [github.com/energychain/willi-mako-client](https://github.com/energychain/willi-mako-client)
2. Klicke auf den grünen **Code**-Button
3. Wähle **Codespaces** Tab
4. Klicke auf **Create codespace on main**

GitHub Codespaces lädt automatisch:
- ✅ Node.js 20 LTS
...
⏱️ **Nachfolgende Öffnungen:** ~15-30 Sekunden (dank Prebuilds)
...
Im Terminal (unten im Codespace) eingeben:
...
**💎 Pro-Tipp: Codespaces Secrets**

Damit du nicht bei jedem Start die Credentials eingeben musst:

1. Gehe zu [github.com/settings/codespaces](https://github.com/settings/codespaces)
2. Klicke auf **New secret**
3. Erstelle Secrets:
   - Name: `WILLI_MAKO_EMAIL`, Value: `deine@email.de`
   - Name: `WILLI_MAKO_PASSWORD`, Value: `dein-passwort`
4. Wähle: **Selected repositories** → `willi-mako-client`

Diese werden dann automatisch als ENV-Variablen geladen! 🎉
...
- Bestellung eines Netzanschlusses
...
1. Stoppe den Codespace und starte neu
2. Prüfe [GitHub Status](https://www.githubstatus.com/)
3. Erstelle einen neuen Codespace (alte werden automatisch nach 30 Tagen Inaktivität gelöscht)

### Problem: Desktop VS Code verbindet nicht

**Lösung:**

1. Installiere die **GitHub Codespaces Extension** in VS Code
2. Öffne Command Palette (`Cmd/Ctrl+Shift+P`)
3. Suche: "Codespaces: Connect to Codespace"
4. Wähle deinen aktiven Codespace
...
|---------|-----------|--------|
| Kostenlose Stunden/Monat | **60h** | 50h |
| GitHub-Integration | ✅ Nativ | ⚠️ Via OAuth |
| VS Code Desktop | ✅ | ✅ |
| Browser-IDE | ✅ | ✅ |
| Prebuilds | ✅ | ✅ |
| Secrets Management | ✅ Nativ | ⚠️ Manuell |
| Start-Zeit | ~15-30s | ~30s |

**💡 Empfehlung:** Nutze Codespaces für nahtlose GitHub-Integration oder Gitpod als Alternative!
...
- 🌐 [Gitpod Quickstart](./GITPOD_QUICKSTART.md) (Alternative)
